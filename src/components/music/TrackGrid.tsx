    ...
    return (
      <div className="flex flex-col items-center justify-center rounded-3xl border-2 border-dashed border-pink-200 bg-pink-50/50 py-16">
        <div className="relative mb-4">
          <div className="flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-pink-200 to-rose-200">
            <Music2 className="h-10 w-10 text-pink-400" />
          </div>
          <Disc3 className="absolute -bottom-1 -right-1 h-8 w-8 animate-spin text-pink-300" style={{ animationDuration: '3s' }} />
        </div>
        <h3 className="mb-1 text-lg font-bold text-pink-600">Chưa có bài nhạc nào</h3>
        <p className="text-sm text-pink-400">Hãy thêm bài nhạc đầu tiên bằng link YouTube hoặc Spotify nhé! 🎶</p>
      </div>
    );
  }
