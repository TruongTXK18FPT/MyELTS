...
export const grammarSeedEntries: GrammarSeedEntry[] = [
  {
    ...
    structurePattern: 'S + V(s/es) + O. | S + do/does not + V + O. | Do/Does + S + V + O?',
  ...
  },
  {
    ...
    structurePattern: 'S + am/is/are + V-ing + O.',
  ...
  },
  {
    ...
    structurePattern: 'S + have/has + V3/ed + O.',
  ...
  },
  {
    ...
    structurePattern: 'S + V2/ed + O. | S + did not + V + O. | Did + S + V + O?',
  ...
  },
  {
    ...
    structurePattern: 'S + was/were + V-ing + O.',
  ...
  },
  {
    ...
    usageGuide:
      'Will cho quyết định tức thì hoặc dự đoán; going to cho kế hoạch có ý định rõ; Present Continuous cho lịch hẹn cụ thể.',
    structurePattern: 'S + will + V. | S + am/is/are going to + V. | S + am/is/are + V-ing + time expression.',
  ...
  },
  {
    ...
    structurePattern: 'S + modal + V(base).',
  ...
  },
  {
    ...
    structurePattern: 'a/an + singular countable noun | much + uncountable noun | many + plural noun',
  ...
  },
  {
    ...
    structurePattern: 'a/an + singular countable noun | the + specific noun',
  ...
  },
  {
    ...
    structurePattern: 'A is adj-er than B. | A is more adj than B. | A is the adj-est.',
  ...
  },
  {
    ...
    structurePattern: 'enjoy + V-ing | decide + to V | stop + V-ing / stop + to V',
  ...
  },
  {
    ...
    structurePattern: 'S + be + V3/ed (+ by O).',
  ...
  },
  {
    ...
    structurePattern: 'Noun + who/which/that + clause.',
  ...
  },
  {
    ...
    structurePattern:
      'Type 0: If + present, present. | Type 1: If + present, will + V. | Type 2: If + past, would + V. | Type 3: If + past perfect, would have + V3.',
  ...
  },
  {
    ...
    structurePattern: 'S + said (that) + clause. | S + told + O + that + clause.',
  ...
  },
  {
    ...
    structurePattern: 'Main clause, auxiliary + pronoun?',
  ...
  },
  {
    ...
    structurePattern: 'at + clock time | on + day/date | in + month/year/place area',
  ...
  },
  {
    ...
    structurePattern: 'Clause + conjunction + clause | Linker, clause.',
  ...
  },
  {
    ...
    structurePattern: 'Noun + where/when/why + clause.',
  ...
  },
  {
    ...
    structurePattern: 'S + wish/if only + past simple/past perfect/would + V.',
  ...
  },
  {
    ...
    structurePattern: 'Negative adverbial + auxiliary + subject + verb.',
  ...
  },
  {
    ...
    structurePattern: 'It is/was + focused element + that/who + clause.',
  ...
  },
  {
    ...
    structurePattern: 'S + have/has been + V-ing + O. | Have/Has + S + been + V-ing + O?',
  ...
  },
  {
    ...
    structurePattern: 'S + had + V3/ed + O. | S + had not + V3/ed + O.',
  ...
  },
  {
    ...
    structurePattern: 'S + had been + V-ing + O. | Had + S + been + V-ing + O?',
  ...
  },
  {
    ...
    structurePattern: 'S + will be + V-ing + O.',
  ...
  },
  {
    ...
    structurePattern: 'S + will have + V3/ed + O.',
  ...
  },
  {
    ...
    structurePattern: 'S + will have been + V-ing + O + for/since + time.',
  ...
  },
  {
    ...
    structurePattern: 'Singular subject + singular verb. | Plural subject + plural verb.',
  ...
  },
  {
    ...
    structurePattern: 'What/That + clause + verb. | Subject + verb + that/whether/wh-clause.',
  ...
  },
  {
    ...
    structurePattern: 'Main clause + because/although/while + clause. | Because/Although + clause, main clause.',
  ...
  },
  {
    ...
    structurePattern: 'V-ing clause, main clause. | V3/ed clause, main clause. | Having + V3, main clause.',
  ...
  },
  {
    ...
    structurePattern: 'If + past perfect, would + V. | If + past simple, would have + V3.',
